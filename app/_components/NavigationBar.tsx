...
export function NavigationBar() {
  ...
  return (
    <nav className="fixed border-b border-verde-musgo h-[80px] w-full flex items-center justify-center z-50 bg-white/44 supports-[backdrop-filter]:backdrop-blur-3xl backdrop-blur-none">
