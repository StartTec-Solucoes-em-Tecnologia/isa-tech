...
export default function FadeCarrossel() {
  ...
  return (
    <div className="flex flex-row justify-evenly gap-12 w-4/5 items-center">
      <div className="flex lg:flex-wrap gap-6 lg:gap-16 w-1/4 flex-row lg:flex-col overflow-y-auto lg:overflow-y-hidden relative pl-6 lg:pl-0 py-4">
        {featureCards.map(
          (item, index) =>
      ...
      <div className="flex relative w-2/4 h-full items-center">
        <Image
